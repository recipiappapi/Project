...
Insert into Staff(staff_name,gender,staff_role,staff_address,contact_number,join_date) values('Shuba Tamang','Female','Cleaning','Kathmandu',98465987623,Timestamp '2022-1-15 14:30:00');
Insert into Staff(staff_name,gender,staff_role,staff_address,contact_number,join_date) values('Sita Poudel','Female','Cooking','Sagarmatha',98465987625,Timestamp '2022-1-16 10:30:00');
Insert into Staff(staff_name,gender,staff_role,staff_address,contact_number,join_date) values('Binita Kc','Female','Helper','Hetauda',98465987627,Timestamp '2022-5-15 11:30:00');
Insert into Staff(staff_name,gender,staff_role,staff_address,contact_number,join_date) values('Rita Magar','Female','Cleaning','Pokhara',98465987648,Timestamp '2022-6-15 12:30:00');
Insert into Staff(staff_name,gender,staff_role,staff_address,contact_number,join_date) values('Ravi Magar','Male','Driver','Pokhara',98465987665415,Timestamp '2022-6-14 12:30:00');
Insert into Staff(staff_name,gender,staff_role,staff_address,contact_number,join_date) values('Kopila Magar','Female','Cleaning','Birgunj',98461651,Timestamp '2022-6-17 12:30:00');
Insert into Staff(staff_name,gender,staff_role,staff_address,contact_number,join_date) values('Shiva Puri','Male','Lab assistance','Sagarmatha',98466215448,Timestamp '2022-6-20 12:30:00');
Insert into Staff(staff_name,gender,staff_role,staff_address,contact_number,join_date) values('Salin Thakuri','Male','Data Administator','Kathmandu',984659448,Timestamp '2022-6-26 12:30:00');
Insert into Staff(staff_name,gender,staff_role,staff_address,contact_number,join_date) values('Kabita Luitel','Female','Cleaning','Pokhara',984659854588,Timestamp '2022-6-27 12:30:00');
...
Execute pay_fee('s1',3000);
Execute pay_fee('s2',5000);
Execute pay_fee('s3',2000);
...
Execute deposite_salary_to_teacher_account('t2',3000);
Execute deposite_salary_to_teacher_account('t3',1500);
Execute deposite_salary_to_teacher_account('t4',1600);
...
execute deposite_salary_to_staff_account('st2',900);
execute deposite_salary_to_staff_account('st3',1000);
execute deposite_salary_to_staff_account('st4',700);
execute deposite_salary_to_staff_account('st5',800);
execute deposite_salary_to_staff_account('st6',900);
execute deposite_salary_to_staff_account('st7',1000);
execute deposite_salary_to_staff_account('st8',700);
execute deposite_salary_to_staff_account('st9',700);
...
/
select * from Teacher_account;
execute salary_withdraw_teacher('t1',700);
execute salary_withdraw_teacher('t2',500);
execute salary_withdraw_teacher('t3',600);
execute salary_withdraw_teacher('t4',900);
...
Execute salary_withdraw_staff('st1',200);
Execute salary_withdraw_staff('st2',600);
Execute salary_withdraw_staff('st3',500);
Execute salary_withdraw_staff('st4',300);
Execute salary_withdraw_staff('st5',150);
Execute salary_withdraw_staff('st6',160);
Execute salary_withdraw_staff('st7',50);
Execute salary_withdraw_staff('st8',700);
...
where    Student_Account.remaining_fee >3000   and    Sport_Items__Issued_and_Return_Item.Fine_Amount >50;
...
select 
     ...
     Teacher.teacher_address,
     Teacher.contact_number,
     Teacher_account.remaining_salary
From Teacher
Left join Teacher_account on Teacher.teacher_id = Teacher_account.teacher_account_id
where remaining_salary >700
Union
Select
   Staff.staff_id,
   Staff.staff_name,
   ...
   Staff_account.remaining_salary
From Staff
Right Join Staff_account on Staff.staff_id = Staff_account.staff_account_id
where    Staff_account.remaining_salary > 500;
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------NESTED QUERY---------------------------------------------------------------------------------------------------------------------

select 
Student.student_id,Student.student_name,Student.student_department,
Student.student_current_semester,Student.student_address,Student.student_contact_number
from Student
Where Student.student_id In(
    Select Sport_Items__Issued_and_Return_Item.Issuder_id
    from Sport_Items__Issued_and_Return_Item
    where Sport_Items__Issued_and_Return_Item.Fine_Amount>=50
);
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------Current TimeStamp-------------------------------------------------------------------------------------------------------------------------------
SELECT 
...
Teacher
where 
join_date <= CURRENT_TIMESTAMP - INTERVAL '1' Year;
-----------------------------------------------------------------------------------------------OLAP-------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
SELECT 
gender,
sum(TOTAL_SALARY) as Total_Salary_sum
from Staff s
join 
Staff_account sa on s.Staff_id = sa.STAFF_ACCOUNT_ID
group by 
cube(Gender);
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
